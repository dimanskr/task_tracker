...
### 3. Запустите docker-compose:
   ...
   ```
###   *Backend приложение будет доступно по адресу http://127.0.0.1:8000/api/*
...
Через эндпоинт зарегистрируйте пользователя по адресу http://127.0.0.1:8000/api/users/register/ 
и назначите ему права модератора в админке.\
Войдите в систему используя программу Postman через эндпоинт http://127.0.0.1:8000/api/users/login/ \
...
|------------------------------------------------|----------------|-------------------------------|--------------| 
| http://127.0.0.1:8000/api/users/register/      | `POST`         | создание пользователя         | AllowAny     |
| http://127.0.0.1:8000/api/users/login/         | `POST`         | вход                          | AllowAny     |   
| http://127.0.0.1:8000/api/users/token/refresh/ | `POST`         | сброс токена                  | AllowAny     |
| http://127.0.0.1:8000/api/users/               | `GET`          | просмотр списка пользователей | Moder        |
| http://127.0.0.1:8000/api/users/{id}/          | `GET`          | просмотр пользователя         | Moder, User  |
| http://127.0.0.1:8000/api/users/update/{id}/   | `PUT`, `PATCH` | изменение пользователя        | User         |
| http://127.0.0.1:8000/api/users/delete/{id}/   | `DELETE`       | удаление пользователя         | Moder, User  |
...
| path                                       | methods        | description                 | permissions |
|--------------------------------------------|----------------|-----------------------------|-------------| 
| http://127.0.0.1:8000/api/employees/       | `POST`         | создание сотрудника         | Moder       |
| http://127.0.0.1:8000/api/employees/       | `GET`          | просмотр списка сотрудников | AllowAny    |   
| http://127.0.0.1:8000/api/employees/{id}/  | `GET`          | просмотр сотрудника         | Moder, User |
| http://127.0.0.1:8000/api/employees/{id}/  | `PUT`, `PATCH` | изменение сотрудника        | Moder, User |
| http://127.0.0.1:8000/api/employees/{id}/  | `DELETE`       | удаление сотрудника         | Moder       |
...
| Path                                        | Methods        | Description           | Permissions |
|---------------------------------------------|----------------|-----------------------|-------------|
| http://127.0.0.1:8000/api/task-list/        | `GET`          | просмотр списка задач | AllowAny    |
| http://127.0.0.1:8000/api/task/{id}/        | `GET`          | просмотр задачи       | AllowAny    |
| http://127.0.0.1:8000/api/task/create/      | `POST`         | создание  задачи      | Moder       |
| http://127.0.0.1:8000/api/task/update/{id}/ | `PUT`, `PATCH` | изменение  задачи     | Moder       |
| http://127.0.0.1:8000/api/task/delete/{id}/ | `DELETE`       | удаление  задачи      | Moder       |

## Специальные эндпоинты:

| Path                                       | Methods | Description                                                           | Permissions |
|--------------------------------------------|---------|-----------------------------------------------------------------------|------------|
| http://127.0.0.1:8000/api/employees-tasks/ | `GET`   | список сотрудников в порядке убывания <br/>количества активных задач  | AllowAny    |
| http://127.0.0.1:8000/api/important-tasks/ | `GET`   | список важных задач со списком сотрудников <br/>для их выполнения     | AllowAny    |
